                    ...
                    <div className="flex-1 overflow-y-auto scrollbar-hide py-6 px-4 space-y-8">
                      <section className="space-y-4">
                        <div className="px-4 flex items-center gap-2">
                           ...
                           <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary/30">Settings</span>
                        </div>
                                ...
                                <SheetHeader>
                                  <div className="flex items-center gap-4">
                                    ...
                                    <div className="space-y-1 text-left">
                                      <SheetTitle className="text-2xl font-headline italic text-primary">Region.</SheetTitle>
                                      <p className="text-[10px] font-black uppercase tracking-widest text-primary/30">Select sanctuary region</p>
                                    </div>
                                  </div>
                                </SheetHeader>
                          ...
                          >
                            <div className="flex items-center gap-4">
                              ...
                              <div className="space-y-0.5">
                                ...
                                <div className="text-xs text-muted-foreground italic uppercase tracking-widest">{theme}</div>
                              </div>
                            </div>
